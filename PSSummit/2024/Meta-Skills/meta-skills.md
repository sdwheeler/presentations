...
Today I want to talk to you about meta skills - what they are, why they matter, and how you can
...
- Are not (usually) absolute rulers - they have to listen to everyone else and usually decide
  transparently and with consensus.

## Slide 6 - Systems Mastery

All of that context laid down, let's talk about the first meta skill: Systems mastery.
...
conversation that takes time and energy, filing issues like "I expected X to work like Y, but Z
happens. Here's the steps to reproduce the provlem..." means that the team can learn everything they
need to know about the problem from your report, and they can fix it more quickly and with a higher
chance of solving the actual problem.

Similarly, when filing improvements instead of "This project should X" try writing a user story,
like "As a <person>, I want <feature> so that <value>..." - this helps the team understand who wants
the feature, what the feature should do, and why it's valuable. These are questions they need to
answer to prioritize the work. The easier it is to understand and prioritize, the more likely it is
...
- When an issue is closed, it might be for any number of reasons - was it a bug they couldn't
  how the maintainers decide whether to close an issue can help you understand whether you should
  try an alternative or move on, or whether the issue is open to further discussion.
  more into this problem later on, but for now you can think about how the team is making those
...
value to the project - obvious to some is not obvious to all, and understanding what's happening is
...
> Your ability to **analyze** and effectively **allocate** your available resources to salve problems
...
The last skill to discuss is the meta meta-skill, which builds on all of the others - lateral
thinking.
